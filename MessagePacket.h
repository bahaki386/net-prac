...
/* チャットテキスト */
#define MID_CHAT_TEXT				(0x1010)	/* クライアント <--> サーバ */

/* グループへの参加要求と応答 */
#define MID_JOIN_REQUEST			(0x1021)	/* クライアント ---> サーバ */
#define MID_JOIN_RESPONSE			(0x1022)	/* クライアント <--- サーバ */

/* グループからの退出要求と応答 */
#define MID_LEAVE_REQUEST			(0x1031)	/* クライアント ---> サーバ */
#define MID_LEAVE_RESPONSE			(0x1032)	/* クライアント <--- サーバ */
...
/* 特定の参加者に対するチャットテキスト */
#define MID_PRIVATE_CHAT_TEXT		(0xa010)	/* クライアント <--> サーバ */

/* チャットグループ情報の要求と応答 */
#define MID_GROUP_INFO_REQUEST		(0xa021)	/* クライアント ---> サーバ */
#define MID_GROUP_INFO_RESPONSE		(0xa022)	/* クライアント <--- サーバ */

/* チャットグループ内の参加者リスト要求と応答 */
#define MID_USER_LIST_REQUEST		(0xa031)	/* クライアント ---> サーバ */
#define MID_USER_LIST_RESPONSE		(0xa032)	/* クライアント <--- サーバ */

/* 一定時間応答の無いクライアントに対しての接続確認要求と応答 */
#define MID_CONFIRMATION_REQUEST	(0xa041)	/* サーバ ---> クライアント */
#define MID_CONFIRMATION_RESPONSE	(0xa042)	/* サーバ <--- クライアント */
